...
export const Heading = () => {
    ...
    return (
        <div className="lg:flex items-center justify-center max-w-7xl mb-[10rem]">
            <div className="lg:text-start">
                ...
                <div className="flex">
                    <input type="text" className="border rounded-[7px] max-w-[400px] h-[40px]" placeholder="Who are you looking for?"/>
